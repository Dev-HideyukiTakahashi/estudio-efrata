...
const galleryItems = [
  { id: 1, src: "/images/placeholder.svg", alt: "Corte feminino", category: "feminino", size: "large" },
  ...
  { id: 4, src: "/images/placeholder.svg", alt: "Corte masculino", category: "masculino", size: "small" },
  { id: 5, src: "/images/placeholder.svg", alt: "Barba", category: "masculino", size: "large" },
  { id: 6, src: "/images/placeholder.svg", alt: "Corte feminino", category: "feminino", size: "small" },
  { id: 7, src: "/images/placeholder.svg", alt: "Barboterapia", category: "masculino", size: "small" },
  { id: 8, src: "/images/placeholder.svg", alt: "Transformação", category: "feminino", size: "medium" },
  { id: 9, src: "/images/placeholder.svg", alt: "Estilo masculino", category: "masculino", size: "medium" },
]
