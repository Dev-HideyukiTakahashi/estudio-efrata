...
// ==========================================
// 1. DADOS ESTÁTICOS DOS SERVIÇOS
// ==========================================
...
const brunoServices: Service[] = [
  {
    ...
    description:
      'Corte moderno e personalizado com tesoura e máquina, finalização com produtos premium.',
    duration: 60,
    price: 120,
  },
  {
  ...
  },
  {
    ...
    description:
      'Barba completa com toalhas quentes, óleos essenciais e massagem facial relaxante.',
    duration: 75,
    price: 150,
  },
  {
...
export function Services({ onBookClick }: ServicesProps) {
  // Variável de estado para controlar a aba ativa ('valeria' | 'bruno')
  ...
  return (
    ...
    <section id="servicos" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 cursor-default">
        ...
        {/* ========================================== */}
        {/* 4. ABAS DE SELEÇÃO (VALÉRIA / BRUNO)      */}
        {/* ========================================== */}
              ...
              >
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    >
                      {activeTab === 'valeria' ? <Sparkles size={20} /> : <Scissors size={20} />}
                    </div>
                    <span
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-full text-sm font-medium transition-all duration-300 cursor-pointer ${
                      activeTab === 'valeria'
