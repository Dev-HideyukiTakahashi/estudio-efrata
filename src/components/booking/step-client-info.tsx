    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-white/40 text-sm">
          Informe seus dados para o agendamento
        </p>
      </div>

      <form onSubmit={handleSubmit((data) => onSubmit(data.name, data.phone, data.notes || ""))} className="space-y-4">
        <div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.99 }}
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl text-sm font-medium hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300"
        >
          Continuar
        </motion.button>
      </form>
